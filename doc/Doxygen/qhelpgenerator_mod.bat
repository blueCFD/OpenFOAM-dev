...
rem 
rem  Script
rem      qhelpgenerator_mod.bat
rem 
rem  Description
rem      This batch file creates a jump for the real qhelpgenerator_mod file.
rem      Requires a working MSys environment.
rem 
rem ------------------------------------------------------------------------------
@echo on

sh.exe -c "%WM_PROJECT_DIR%/doc/Doxygen/qhelpgenerator_mod %*"
