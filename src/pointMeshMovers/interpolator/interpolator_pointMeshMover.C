...
#include "interpolator_pointMeshMover.H"
...
Foam::pointMeshMovers::interpolator::interpolator
(
    const polyMesh& mesh,
...
Foam::pointMeshMovers::interpolator::curPointField() const
{
...
void Foam::pointMeshMovers::interpolator::write(Ostream& os) const
{
