...
#include "symmetryLagrangianPatch.H"
...
namespace Foam
{
    defineTypeNameAndDebug(symmetryLagrangianPatch, 0);
...
Foam::symmetryLagrangianPatch::symmetryLagrangianPatch
(
...
void Foam::symmetryLagrangianPatch::evaluate
(
    PstreamBuffers&,
    LagrangianMesh& mesh,
