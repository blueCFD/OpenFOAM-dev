...
#include "symmetryPlaneLagrangianPatch.H"
...
namespace Foam
{
    defineTypeNameAndDebug(symmetryPlaneLagrangianPatch, 0);
...
Foam::symmetryPlaneLagrangianPatch::symmetryPlaneLagrangianPatch
(
...
void Foam::symmetryPlaneLagrangianPatch::evaluate
(
    PstreamBuffers&,
    LagrangianMesh& mesh,
