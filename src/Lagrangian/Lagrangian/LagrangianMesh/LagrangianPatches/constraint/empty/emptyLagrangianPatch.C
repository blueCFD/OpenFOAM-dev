...
#include "emptyLagrangianPatch.H"
...
namespace Foam
{
    defineTypeNameAndDebug(emptyLagrangianPatch, 0);
...
Foam::emptyLagrangianPatch::emptyLagrangianPatch
(
...
void Foam::emptyLagrangianPatch::evaluate
(
    PstreamBuffers&,
    LagrangianMesh& mesh,
