...
#include "cell_LagrangianAccumulationScheme.H"
...
template<class Type>
void Foam::Lagrangian::accumulationSchemes::cell<Type>::accumulate
(
...
)
{
    ...
    {
        cPsi[lMesh.celli()[lSubMesh.start() + subi]] += lPsi[subi];
    }
}
