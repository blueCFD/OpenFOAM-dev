...
#include "BasicLagrangianThermo.T.H"
...
template<class MixtureType, class BasicThermoType>
Foam::word
Foam::BasicLagrangianThermo<MixtureType, BasicThermoType>::mixtureName() const
{
...
template<class MixtureType, class BasicThermoType>
Foam::tmp<Foam::LagrangianSubScalarField>
Foam::BasicLagrangianThermo<MixtureType, BasicThermoType>::hs
(
    const LagrangianSubMesh& subMesh
) const
{
...
template<class MixtureType, class BasicThermoType>
Foam::tmp<Foam::LagrangianSubScalarField>
Foam::BasicLagrangianThermo<MixtureType, BasicThermoType>::ha
(
    const LagrangianSubMesh& subMesh
) const
{
