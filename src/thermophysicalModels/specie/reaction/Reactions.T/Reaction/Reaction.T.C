...
<<<<<<< HEAD:src/thermophysicalModels/specie/reaction/Reactions.T/Reaction/Reaction.T.C
#include "Reaction.T.H"
#include "DynamicList.T.H"
=======
#include "Reaction.H"
>>>>>>> blueCFD-Core-7:src/thermophysicalModels/specie/reaction/Reactions/Reaction/Reaction.C
