    ...
    if (radiation_)
    {
        ...
        (
            ...
            (
                ...
                this->mesh(),
                dimensionedScalar(pow4(dimensions::temperature), 0)
            )
        );
        ...
        (
            ...
            (
                ...
                dimensionedScalar
                (
                    dimensions::area*pow4(dimensions::temperature),
                    0
                )
            )
        );
...
:
    ...
    (
        ...
        (
            ...
            this->mesh(),
            dimensionedScalar(dimensions::energy, 0)
        )
    ),
    hsCoeff_
    (
        ...
        (
            ...
            this->mesh(),
            dimensionedScalar(dimensions::energy/dimensions::temperature, 0)
        )
    )
{
    setModels();
