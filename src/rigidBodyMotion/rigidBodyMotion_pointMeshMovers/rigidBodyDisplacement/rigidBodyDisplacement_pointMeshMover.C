...
#include "rigidBodyDisplacement_pointMeshMover.H"
#include "polyMesh.H"
...
Foam::pointMeshMovers::rigidBodyDisplacement::bodyMesh::bodyMesh
(
    const polyMesh& mesh,
    const word& name,
    const label bodyID,
...
:
    ...
    meshSolver_(refCast<pointMeshMovers::displacement>(meshSolverPtr_()))
{
    if (rhoName_ == "rhoInf")
    {
...
void Foam::pointMeshMovers::rigidBodyDisplacement::movePoints
(
...
void Foam::pointMeshMovers::rigidBodyDisplacement::topoChange
(
...
void Foam::pointMeshMovers::rigidBodyDisplacement::mapMesh
(
...
void Foam::pointMeshMovers::rigidBodyDisplacement::distribute
(
...
bool Foam::pointMeshMovers::rigidBodyDisplacement::write() const
{
