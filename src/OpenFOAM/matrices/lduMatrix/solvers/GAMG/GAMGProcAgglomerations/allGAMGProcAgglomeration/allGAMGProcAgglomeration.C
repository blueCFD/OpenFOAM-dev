...
#include "allGAMGProcAgglomeration.H"
...
namespace Foam
{
    defineTypeNameAndDebug(allGAMGProcAgglomeration, 0);
...
Foam::allGAMGProcAgglomeration::allGAMGProcAgglomeration
(
...
bool Foam::allGAMGProcAgglomeration::agglomerate()
{
    if (debug)
    {
